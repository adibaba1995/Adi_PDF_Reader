...
public class PdfViewFragment extends Fragment implements FilePicker.FilePickerSupport {
    public static final String FILE_NAME = "com.adisoftwares.bookreader.pdf.FILE_NAME";
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.pdf_view_fragment_menu, menu);
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        path = getActivity().getIntent().getData().toString();
    ...
    public void createUI(Bundle savedInstanceState) {
        ...
        /*mDocView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
        ...
        mOutlineButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra(OutlineActivity.CORE_OBJECT, core);
                intent.putExtra(OutlineActivity.FILE_PATH, path);
                intent.putExtra(OutlineActivity.PAGE_NO, mDocView.getDisplayedViewIndex());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case OUTLINE_REQUEST:
                if (resultCode >= 0)
                    mDocView.setDisplayedViewIndex(data.getIntExtra(OutlineActivity.PAGE_NO_SELECTED, 0));
                break;
            case PRINT_REQUEST:
...
//					break;
    ...
    public boolean onSearchRequested() {
        if (mControlsVisible && mTopBarMode == TopBarMode.Search) {
            hideControls();
        } else {
            showControls();
            searchModeOn();
