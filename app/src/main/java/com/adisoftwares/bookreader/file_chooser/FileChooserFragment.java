...
/**
 * Created by adityathanekar on 12/03/16.
 */
public class FileChooserFragment extends Fragment implements FileChooser {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.daidalos_file_chooser, container, false);
...
//    }
    ...
    public LinearLayout getRootLayout() {
        View root = mRootView.findViewById(R.id.rootLayout);
